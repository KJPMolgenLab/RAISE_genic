...
args=c("/scratch/fuchs/agchiocchetti/public/data/ASC_Data_2022/ccdg_asc_ndd_daly_talkowski_goethe_asd_exome/LGD_ccdg_asc_ndd_daly_talkowski_goethe_asd_exome.vcf.gz.raw.part_ab",
       "/scratch/fuchs/agchiocchetti/public/data/ASC_Data_2022/ccdg_asc_ndd_daly_talkowski_goethe_asd_exome/LGD_ccdg_asc_ndd_daly_talkowski_goethe_asd_exome.vcf.gz.bim", "ASC_part_ab")
...
gethitgenes=function(patID="FINKPH_EPI-BIO_AA0268A", genofile=LGDS.gen, bimfile=LGDs.bim){
    hgnchit = paste0(bimfile[,grep("^gene$|^genes$", colnames(bimfile))][which(genofile[patID,]>0)], collapse = ";") %>% gsub(";;", ";", .)
...
if(T){
    ...
    LGDs.bim[as.numeric(names(hitgenes)), "genes"] = hitgenes   
